...
namespace Statistics.Test
{
    public class StatsUnitTest
    {
        ...
        public void ReportsNaNForEmptyInput()
        {
            ...
            Assert.Equal(Math.Abs(statsComputer.average), double.NaN);
            Assert.Equal(Math.Abs(statsComputer.max), double.NaN);
            Assert.Equal(Math.Abs(statsComputer.min), double.NaN);
